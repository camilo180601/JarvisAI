...
@tool(
    name='tool_creator',
    description="Crea tools nuevas en runtime escribiendo código Python. Usa cuando el usuario pida 'aprende a hacer X'.",
    parameters={'type': 'OBJECT',
     'properties': {'tool_name': {'type': 'STRING',
                                  'description': 'Nombre de la herramienta en snake_case'},
                    'description': {'type': 'STRING',
                                    'description': 'Descripción clara de la herramienta y para qué '
                                                   'sirve'},
                    'parameters_schema': {'type': 'STRING',
                                          'description': "El bloque de 'properties' del JSON schema en "
                                                         'formato string válido. Ej: \'{"accion": '
                                                         '{"type": "STRING"}}\''},
