...
@tool(
    ...
    description='Auto-programación con sandbox: create_tool, fix_tool, test_tool, list_tools. Compila, ejecuta en aislamiento, inyecta plugin.',
    parameters={'type': 'OBJECT',
     'properties': {'action': {'type': 'STRING',
                               'description': 'create_tool (crear/actualizar) | fix_tool (corregir '
                                              'error) | test_tool (probar en sandbox) | list_tools '
                                              '(listar creadas)'},
                    ...
                    'parameters_schema': {'type': 'STRING',
                                          'description': 'JSON de propiedades de parámetros. Ej: '
                                                         '\'{"param": {"type": "STRING"}}\''},
                    'python_code': {'type': 'STRING',
                                    'description': 'Código Python con la función def '
                                                   '<tool_name>(parameters: dict, player=None) -> '
                                                   'str:'},
                    'test_parameters': {'type': 'OBJECT',
                                        'description': 'Parámetros mock de prueba para evaluar la '
                                                       'ejecución de la función en el sandbox'}},
