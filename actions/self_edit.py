...
@tool(
    name='self_edit',
    description='Edita tu propio código con backup automático. Acciones: read_file, edit_file (target+replacement), append_file, create_file, list_files, list_backups, restore_backup. Cambios en main.py o prompt requieren reinicio.',
    parameters={'type': 'OBJECT',
     'properties': {'action': {'type': 'STRING',
                               'description': 'read_file — leer un archivo del proyecto | edit_file — '
                                              'buscar y reemplazar texto en un archivo (requiere '
                                              'target y replacement) | append_file — agregar contenido '
                                              'al final de un archivo | create_file — crear o '
                                              'sobrescribir un archivo | list_files — listar archivos '
                                              'de un directorio | list_backups — ver backups '
                                              'disponibles | restore_backup — restaurar un backup '
                                              'anterior'},
                    'file': {'type': 'STRING',
                             'description': "Ruta del archivo relativa al proyecto (ej: 'main.py', "
                                            "'actions/terminal_agent.py', 'core/prompt.txt')"},
                    'target': {'type': 'STRING',
                               'description': 'Para edit_file: el texto EXACTO a buscar (incluyendo '
                                              'espacios e indentación)'},
                    'replacement': {'type': 'STRING',
                                    'description': 'Para edit_file: el texto que reemplazará al '
                                                   'target'},
                    'content': {'type': 'STRING',
                                'description': 'Para append_file/create_file: el contenido a escribir'},
                    'directory': {'type': 'STRING',
                                  'description': 'Para list_files: directorio a listar (default: raíz '
                                                 'del proyecto)'},
                    'backup_name': {'type': 'STRING',
                                    'description': 'Para restore_backup: nombre del archivo .bak a '
                                                   'restaurar'}},
     'required': ['action']},
)
