...
def _open_native(path: Path) -> None:
    """Abre un archivo con su app nativa, cross-platform.
    (os.startfile es SOLO Windows — en Mac/Linux crasheaba.)"""
    if sys.platform == "win32":
        os.startfile(str(path))  # noqa: ELL101 — existe solo en Windows
